    ...
    <section className="relative flex items-start justify-center overflow-hidden lg:pb-10 min-h-[720px] md:min-h-[680px] lg:min-h-min">
      ...
      <motion.picture
        ...
        <source
          ...
          srcSet={`${baseUrl}/images/StaysPage/stays_intro/background_mob.webp`}
        />

        <img
          src={`${baseUrl}/images/StaysPage/stays_intro/background.webp`}
      ...
      {/* White center panel */}
      <div className="relative z-10 mx-auto my-auto lg:my-0 flex w-[86%] max-w-[350px] flex-col items-center justify-center bg-white px-6 py-10 text-center sm:px-8 sm:py-12 lg:px-12 lg:py-12 2xl:px-16 2xl:py-16 md:max-w-[560px] lg:max-w-[710px] 2xl:max-w-[920px]">
        <motion.div
          initial={{
            opacity: 0,
            y: 30,
          ...
          <div className="flex w-full items-center gap-4 lg:gap-8">
            ...
            <img
              src={`${baseUrl}/images/StaysPage/stays_intro/logo.svg`}
              alt="logo"
          ...
          <AnimatePresence mode="wait">
            <motion.h2
              ...
              {t('staysIntro.titleLine1')}
              <br />
              {t('staysIntro.titleLine2')}
              <br />
              {t('staysIntro.titleLine3')}
              <br />
              {t('staysIntro.titleLine4')}
            </motion.h2>
          </AnimatePresence>
