  ...
  return (
    <section
      ...
      <div className="absolute inset-0">
        <img
          src={`${process.env.PUBLIC_URL}/images/ExperiencesPage/experiences_hero/experiences_hero.webp`}
          alt={t('experiencesHero.title')}
