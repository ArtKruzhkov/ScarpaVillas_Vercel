...
export function ExperiencesIntro() {
  ...
  return (
    <section className="relative flex items-start justify-center overflow-hidden pb-10 min-h-[720px] md:min-h-[920px] lg:min-h-min">
      ...
      {/* White center panel */}
      <div className="relative z-10 mx-auto flex w-[86%] max-w-[350px] flex-col items-center justify-center bg-white px-6 py-10 text-center sm:px-8 sm:py-12 lg:px-12 lg:py-12 2xl:px-16 2xl:py-16 md:max-w-[560px] lg:max-w-[710px] 2xl:max-w-[920px]">
        <motion.div
          initial={{
            opacity: 0,
            y: 30,
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="mt-4 md:mt-8 max-w-[390px] font-sans text-[13px] leading-[18px] text-[#2C3654] md:max-w-[410px] md:text-[15px] md:leading-[21px] xl:max-w-[490px] xl:text-[18px] xl:leading-[26px]">
              <p>{t('experiencesIntro.text1')}</p>

              <p className="mx-auto mt-4 md:mt-8 max-w-[250px] sm:max-w-none">
