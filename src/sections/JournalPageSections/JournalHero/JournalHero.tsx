  ...
  return (
    <section
      ...
      <div className="absolute inset-0">
        <img
          src={`${process.env.PUBLIC_URL}/images/JournalPage/journal_hero/journal_hero.png`}
          alt={t('journalHero.title')}
